...
const locales = {
    en: {
        ...
        "settings.download_models": "Download Models",
        "settings.download_desc": "Download all required models (GFPGAN, RealESRGAN, Inswapper) automatically.",
        "settings.downloading": "Downloading models...",
        "settings.download_complete": "All models downloaded successfully!",
        "settings.download_error": "Download failed",
    ...
    ru: {
        ...
        "settings.download_models": "Скачать Модели",
        "settings.download_desc": "Автоматически скачать все необходимые модели (GFPGAN, RealESRGAN, Inswapper).",
        "settings.downloading": "Загрузка моделей...",
        "settings.download_complete": "Все модели успешно загружены!",
        "settings.download_error": "Ошибка загрузки",
        "settings.theme": "Тема",
    ...
    ja: {
        ...
        "settings.download_models": "モデルをダウンロード",
        "settings.download_desc": "必要なすべてのモデル (GFPGAN, RealESRGAN, Inswapper) を自動的にダウンロードします。",
        "settings.downloading": "モデルをダウンロード中...",
        "settings.download_complete": "すべてのモデルのダウンロードが完了しました！",
        "settings.download_error": "ダウンロード失敗",
        "settings.theme": "テーマ",
    ...
    uz: {
        ...
        "settings.download_models": "Modellarni Yuklash",
        "settings.download_desc": "Barcha kerakli modellarni (GFPGAN, RealESRGAN, Inswapper) avtomatik yuklab olish.",
        "settings.downloading": "Modellar yuklanmoqda...",
        "settings.download_complete": "Barcha modellar muvaffaqiyatli yuklandi!",
        "settings.download_error": "Yuklashda xatolik",
